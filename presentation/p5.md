...
2. **Hilbert curve mapping**: Map MBR centres to Hilbert curve positions
...
## Outcomes (1/2): Software and Libraries
...
## Outcomes (2/2): Web Prototype Demo
...
## Discussion (1/4): Use Cases and Applications
...
## Discussion (2/4): Impact on Server Architecture
...
## Discussion (3/4): Limitations and Trade-offs 1: Client-side Complexity
...
## Discussion (4/4): Limitations and Trade-offs 2: Update Operations
